...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Тражи",
		Reset: "Ре�?етуј",
		odata: [{ oper:'eq', text:"једнако"},{ oper:'ne', text:"није једнако"},{ oper:'lt', text:"мање"},{ oper:'le', text:"мање или једнако"},{ oper:'gt', text:"веће"},{ oper:'ge', text:"веће или једнако"},{ oper:'bw', text:"почиње �?а"},{ oper:'bn', text:"не почиње �?а"},{ oper:'in', text:"је у"},{ oper:'ni', text:"није у"},{ oper:'ew', text:"завршава �?а"},{ oper:'en', text:"не завршава �?а"},{ oper:'cn', text:"�?адржи"},{ oper:'nc', text:"не �?адржи"},{ oper:'nu', text:'is null'},{ oper:'nn', text:'is not null'}],
